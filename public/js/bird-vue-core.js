...
;(function (Vue, BIRD_CONFIG, U) {
  ...
  const _TRANSLATIONS = {
    fr: {
      ...
      set_alerts_title:'Alertes système', set_alerts_desc:'Recevez une notification quand un seuil critique est dépassé (via Apprise).',
    ...
    en: {
      ...
      set_alerts_title:'System alerts', set_alerts_desc:'Get notified when a critical threshold is exceeded (via Apprise).',
    ...
    de: {
      ...
      set_alerts_title:'Systemalarme', set_alerts_desc:'Benachrichtigung bei Überschreitung kritischer Schwellenwerte (via Apprise).',
    ...
    nl: {
      ...
      set_alerts_title:'Systeemalarmen', set_alerts_desc:'Ontvang een melding bij overschrijding van kritische drempels (via Apprise).',
