...
;(function (Vue, BIRD_CONFIG, U) {
  ...
  const _TRANSLATIONS = {
    fr: {
      ...
      review_suspects:'{n} suspectes', review_total:'total', review_selected:'{n} sélectionnées', review_select_all:'Tout sélectionner', review_deselect:'Tout désélectionner', review_confirm:'Confirmer', review_reject:'Rejeter', review_reject_rule:'Rejeter par règle', review_confirm_q:'Confirmer {n} détections ?', review_reject_q:'Rejeter {n} détections ?', review_reject_rule_q:'Rejeter {n} détections "{rule}" ?', review_none:'Aucune détection suspecte pour cette période.',
      ...
      weather_activity:'Météo & Activité', temperature:'Température', precipitation:'Précipitations', wind:'Vent',
    ...
    en: {
      ...
      weather_activity:'Weather & Activity', temperature:'Temperature', precipitation:'Precipitation', wind:'Wind',
    ...
    de: {
      ...
      review_suspects:'{n} verdächtig', review_total:'gesamt', review_selected:'{n} ausgewählt', review_select_all:'Alle auswählen', review_deselect:'Alle abwählen', review_confirm:'Bestätigen', review_reject:'Ablehnen', review_reject_rule:'Nach Regel ablehnen', review_confirm_q:'{n} Erkennungen bestätigen?', review_reject_q:'{n} Erkennungen ablehnen?', review_reject_rule_q:'{n} "{rule}" Erkennungen ablehnen?', review_none:'Keine verdächtigen Erkennungen.',
      ...
      weather_activity:'Wetter & Aktivität', temperature:'Temperatur', precipitation:'Niederschlag', wind:'Wind',
    ...
    nl: {
      ...
      weather_activity:'Weer & Activiteit', temperature:'Temperatuur', precipitation:'Neerslag', wind:'Wind',
