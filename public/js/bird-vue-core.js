...
;(function (Vue, BIRD_CONFIG, U) {
  ...
  const _TRANSLATIONS = {
    fr: {
      ...
      weather_activity:'Météo & Activité', weather_correlation:'Corrélation météo/activité', weather_best:'Meilleures conditions : ~{temp}°C, ~{precip}mm pluie/jour', temperature:'Température', precipitation:'Précipitations', wind:'Vent',
    ...
    en: {
      ...
      weather_activity:'Weather & Activity', weather_correlation:'Weather/activity correlation', weather_best:'Best conditions: ~{temp}°C, ~{precip}mm rain/day', temperature:'Temperature', precipitation:'Precipitation', wind:'Wind',
    ...
    de: {
      ...
      weather_activity:'Wetter & Aktivität', weather_correlation:'Wetter/Aktivitäts-Korrelation', weather_best:'Beste Bedingungen: ~{temp}°C, ~{precip}mm Regen/Tag', temperature:'Temperatur', precipitation:'Niederschlag', wind:'Wind',
    ...
    nl: {
      ...
      weather_activity:'Weer & Activiteit', weather_correlation:'Weer/activiteit correlatie', weather_best:'Beste omstandigheden: ~{temp}°C, ~{precip}mm regen/dag', temperature:'Temperatuur', precipitation:'Neerslag', wind:'Wind',
