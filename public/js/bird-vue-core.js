...
;(function (Vue, BIRD_CONFIG, U) {
  ...
  const _TRANSLATIONS = {
    fr: {
      ...
      share:'Partager', analyze_deep:'Analyse approfondie', fav_add:'Ajouter aux favoris', fav_remove:'Retirer des favoris', fav_only:'Favoris uniquement', phenology_calendar:'Calendrier phénologique', notifications:'Notifications', wn_empty:'Rien de nouveau',
      ...
      set_model_desc_perch:'Perch v2 (Google) — 15000 espèces, oiseaux + amphibiens + mammifères, plus précis', set_model_desc_perch_int8:'Perch V2 INT8 (Google) — quantifié ~30% plus rapide, 15K espèces, précision quasi identique. Meilleure utilisation du cache CPU sur Pi 4/5.',
      ...
      dual_model:'Dual-model', dual_desc:'Analyse chaque fichier avec deux modèles en parallèle', secondary_model:'Modèle secondaire', dual_active:'{model} actif', dual_wait:'Le modèle secondaire sera chargé au prochain cycle (~5 min).',
      ...
      review_purge:'Purger les rejetées', review_purge_title:'Suppression des détections rejetées', review_purge_warning:'Les détections suivantes seront supprimées de la base de données et les fichiers audio associés seront effacés. Cette action est irréversible.', review_purge_confirm:'Supprimer définitivement',
      ...
      activity_month_hour:'Activité saisonnière par heure', description:'Description',
      // Detections
      ...
      tl_see_species:'Voir la fiche espèce', tl_listen:'Écouter', tl_validate:'Valider',
      tl_density_label:'Intensité des détections', tl_now:'maintenant', tl_drag_hint:'glisser pour zoomer',
      tl_type_nocturnal:'🌙 Nocturne', tl_type_rare:'⭐ Rare', tl_type_firstyear:'🌱 1ère de l\'année',
      tl_type_firstday:'🐦 1ère diurne', tl_type_best:'🎵 Meilleure', tl_type_out_of_season:'⚠️ Hors-saison',
    ...
    en: {
      ...
      share:'Share', analyze_deep:'Deep analysis', fav_add:'Add to favorites', fav_remove:'Remove from favorites', fav_only:'Favorites only', phenology_calendar:'Phenology calendar', notifications:'Notifications', wn_empty:'Nothing new',
      ...
      set_model_desc_perch:'Perch v2 (Google) — 15,000 species, birds + amphibians + mammals, more accurate', set_model_desc_perch_int8:'Perch V2 INT8 (Google) — quantized ~30% faster, 15K species, near-identical accuracy. Better CPU cache utilization on Pi 4/5.',
      ...
      dual_model:'Dual-model', dual_desc:'Analyze each file with two models in parallel', secondary_model:'Secondary model', dual_active:'{model} active', dual_wait:'Secondary model will load on next cycle (~5 min).',
      ...
      review_purge:'Purge rejected', review_purge_title:'Delete rejected detections', review_purge_warning:'The following detections will be permanently deleted from the database and their audio files will be removed. This action cannot be undone.', review_purge_confirm:'Delete permanently',
      ...
      activity_month_hour:'Seasonal activity by hour', description:'Description',
      ...
      tl_see_species:'See species card', tl_listen:'Listen', tl_validate:'Validate',
      tl_density_label:'Detection intensity', tl_now:'now', tl_drag_hint:'drag to zoom',
      tl_type_nocturnal:'🌙 Nocturnal', tl_type_rare:'⭐ Rare', tl_type_firstyear:'🌱 First of year',
      tl_type_firstday:'🐦 First diurnal', tl_type_best:'🎵 Best detection', tl_type_out_of_season:'⚠️ Out of season',
    ...
    de: {
      ...
      share:'Teilen', analyze_deep:'Tiefenanalyse', fav_add:'Zu Favoriten', fav_remove:'Aus Favoriten entfernen', fav_only:'Nur Favoriten', phenology_calendar:'Phänologie-Kalender', notifications:'Benachrichtigungen', wn_empty:'Nichts Neues',
      ...
      set_model_desc_perch:'Perch v2 (Google) — 15.000 Arten, Vogel + Amphibien + Saugetiere, genauer', set_model_desc_perch_int8:'Perch V2 INT8 (Google) — quantisiert ~30% schneller, 15K Arten, nahezu identische Genauigkeit. Bessere CPU-Cache-Nutzung auf Pi 4/5.',
      ...
      dual_model:'Dual-Modell', dual_desc:'Jede Datei mit zwei Modellen parallel analysieren', secondary_model:'Sekundäres Modell', dual_active:'{model} aktiv', dual_wait:'Sekundärmodell wird beim nächsten Zyklus geladen (~5 Min.).',
      ...
      review_purge:'Abgelehnte löschen', review_purge_title:'Abgelehnte Erkennungen löschen', review_purge_warning:'Die folgenden Erkennungen werden dauerhaft aus der Datenbank gelöscht und die Audiodateien entfernt. Diese Aktion kann nicht rückgängig gemacht werden.', review_purge_confirm:'Endgültig löschen',
      ...
      activity_month_hour:'Saisonale Aktivität nach Stunde', description:'Beschreibung',
      ...
      tl_see_species:'Artkarte anzeigen', tl_listen:'Anhören', tl_validate:'Bestätigen',
      tl_density_label:'Erkennungsintensität', tl_now:'jetzt', tl_drag_hint:'ziehen zum Zoomen',
      tl_type_nocturnal:'🌙 Nachtaktiv', tl_type_rare:'⭐ Selten', tl_type_firstyear:'🌱 Erstnachweis',
      tl_type_firstday:'🐦 Erste tagsüber', tl_type_best:'🎵 Beste Erkennung', tl_type_out_of_season:'⚠️ Außer Saison',
    ...
    nl: {
      ...
      share:'Delen', analyze_deep:'Diepgaande analyse', fav_add:'Toevoegen aan favorieten', fav_remove:'Verwijderen uit favorieten', fav_only:'Alleen favorieten', phenology_calendar:'Fenologiekalender', notifications:'Meldingen', wn_empty:'Niets nieuws',
      ...
      set_model_desc_perch:'Perch v2 (Google) — 15.000 soorten, vogels + amfibieen + zoogdieren, nauwkeuriger', set_model_desc_perch_int8:'Perch V2 INT8 (Google) — gekwantiseerd ~30% sneller, 15K soorten, vrijwel identieke nauwkeurigheid. Betere CPU-cache op Pi 4/5.',
      ...
      dual_model:'Dual-model', dual_desc:'Elk bestand met twee modellen parallel analyseren', secondary_model:'Secundair model', dual_active:'{model} actief', dual_wait:'Secundair model laadt bij volgende cyclus (~5 min).',
      ...
      review_purge:'Afgewezen verwijderen', review_purge_title:'Afgewezen detecties verwijderen', review_purge_warning:'De volgende detecties worden permanent uit de database verwijderd en de audiobestanden worden gewist. Deze actie kan niet ongedaan worden gemaakt.', review_purge_confirm:'Definitief verwijderen',
      ...
      activity_month_hour:'Seizoensactiviteit per uur', description:'Beschrijving',
      ...
      tl_see_species:'Soortkaart bekijken', tl_listen:'Luisteren', tl_validate:'Bevestigen',
      tl_density_label:'Detectie-intensiteit', tl_now:'nu', tl_drag_hint:'sleep om te zoomen',
      tl_type_nocturnal:'🌙 Nachtelijk', tl_type_rare:'⭐ Zeldzaam', tl_type_firstyear:'🌱 Eerste dit jaar',
      tl_type_firstday:'🐦 Eerste overdag', tl_type_best:'🎵 Beste detectie', tl_type_out_of_season:'⚠️ Buiten seizoen',
