...
const ALERT_I18N = {
  en: {
    ...
    sound_low_title:   '🎤 BIRDASH — Microphone silent',
    sound_low_body:    (leq, th, min) => `Average sound level stayed at ${leq} dBFS over the last ${min} minutes (below ${th} dBFS). The microphone may be unplugged, muted, or damaged.`,
    sound_high_title:  '🔊 BIRDASH — Audio clipping',
    sound_high_body:   (leq, th, min) => `Average sound level stayed at ${leq} dBFS over the last ${min} minutes (above ${th} dBFS). Input is likely being overdriven — reduce the software gain or move the mic.`,
  ...
  fr: {
    ...
    sound_low_title:   '🎤 BIRDASH — Micro silencieux',
    sound_low_body:    (leq, th, min) => `Niveau sonore moyen ${leq} dBFS sur les dernières ${min} minutes (sous ${th} dBFS). Le micro est peut-être débranché, coupé ou endommagé.`,
    sound_high_title:  '🔊 BIRDASH — Saturation audio',
    sound_high_body:   (leq, th, min) => `Niveau sonore moyen ${leq} dBFS sur les dernières ${min} minutes (au-dessus de ${th} dBFS). L'entrée est probablement saturée — réduire le gain logiciel ou déplacer le micro.`,
  ...
  de: {
    ...
    sound_low_title:   '🎤 BIRDASH — Mikrofon stumm',
    sound_low_body:    (leq, th, min) => `Durchschnittlicher Schallpegel ${leq} dBFS in den letzten ${min} Minuten (unter ${th} dBFS). Mikrofon möglicherweise nicht angeschlossen, stummgeschaltet oder defekt.`,
    sound_high_title:  '🔊 BIRDASH — Audio-Übersteuerung',
    sound_high_body:   (leq, th, min) => `Durchschnittlicher Schallpegel ${leq} dBFS in den letzten ${min} Minuten (über ${th} dBFS). Eingang wahrscheinlich übersteuert — Software-Verstärkung reduzieren oder Mikrofon umstellen.`,
  ...
  nl: {
    ...
    sound_low_title:   '🎤 BIRDASH — Microfoon stil',
    sound_low_body:    (leq, th, min) => `Gemiddeld geluidsniveau ${leq} dBFS over de afgelopen ${min} minuten (onder ${th} dBFS). Microfoon mogelijk losgekoppeld, gedempt of defect.`,
    sound_high_title:  '🔊 BIRDASH — Audio-clipping',
    sound_high_body:   (leq, th, min) => `Gemiddeld geluidsniveau ${leq} dBFS over de afgelopen ${min} minuten (boven ${th} dBFS). Ingang waarschijnlijk oversturen — softwareversterking verlagen of microfoon verplaatsen.`,
